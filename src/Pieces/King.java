				...
				if (caseCounterK == 0) {
					if (!kingInCheck && p == 60 && g.getOrientation() == 'w') {
						for (int c = 0; c < movePString.length(); c++) {
							...
							if (h == 'F' && pieces[p + 1] == " " && pieces[p + 2] == " "
									&& pieces[p + 3].equals("WR.gifF")) {
								int posPosition = p + 2;
								possibleMoves.add(posPosition);
								possibleMoveSquareColors.add(g.squareColors[posPosition]);
							}
							if (h == 'F' && pieces[p - 1] == " " && pieces[p - 2] == " " && pieces[p - 3] == " "
									&& pieces[p - 4].equals("WR.gifF")) {
								int posPosition = p - 2;
								possibleMoves.add(posPosition);
								possibleMoveSquareColors.add(g.squareColors[posPosition]);
							}
				...
				if (caseCounterK == 0) {
					if (!kingInCheck && p == 4 && g.getOrientation() == 'w') {
						for (int c = 0; c < movePString.length(); c++) {
							...
							if (h == 'F' && pieces[p + 1] == " " && pieces[p + 2] == " "
									&& pieces[p + 3].equals("BR.gifF")) {
								int posPosition = p + 2;
								possibleMoves.add(posPosition);
								possibleMoveSquareColors.add(g.squareColors[posPosition]);
							}
							if (h == 'F' && pieces[p - 1] == " " && pieces[p - 2] == " " && pieces[p - 3] == " "
									&& pieces[p - 4].equals("BR.gifF")) {
								int posPosition = p - 2;
								possibleMoves.add(posPosition);
								possibleMoveSquareColors.add(g.squareColors[posPosition]);
							}
